...
Boid::Boid()
    : position{vec((rand01() - 0.5f) * 0.8f, (rand01() - 0.5f) * 0.8f)}, color{glm::vec3(rand01(), rand01(), rand01())}, direction{vec((rand01() - 0.5f) * 0.001f, (rand01() - 0.5f) * 0.001f)} {}

Boid::Boid(float wander)
    : position{vec((rand01() - 0.5) * 0.8, (rand01() - 0.5) * 0.8)}, color{glm::vec3(rand01(), rand01(), rand01())}, direction{vec((rand01() - 0.5) * wander, (rand01() - 0.5) * wander)} {}
